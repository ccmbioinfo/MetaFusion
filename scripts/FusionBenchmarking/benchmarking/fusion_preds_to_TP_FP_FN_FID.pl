...
main : {
    ...
    while (<$fh>) {
        ...
        my ($sample, $prog_name, $fusion_name, $J, $S, $mapped_A_list, $mapped_B_list, $FID, @rest) = @x;
        ...
        print join("\t", $pred_result, $sample, $prog_name, $fusion_name, $J, $S, $mapped_A_list, $mapped_B_list, $explanation, $fusion_selected, $FID) . "\n";
